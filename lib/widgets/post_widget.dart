...
import 'package:instagramie/widgets/comment_widget.dart';
import 'package:instagramie/widgets/heart_icon_animator.dart';
import 'package:instagramie/widgets/heart_overlay_animator.dart';
            ...
            children: <Widget>[
              CarouselSlider(
                ...
                options: CarouselOptions(
                  viewportFraction: 1.0,
                  enableInfiniteScroll: false,
                  onPageChanged: (index, reason) => _updateImageIndex(index),
                ),
              ),
        ...
        Row(
          ...
          children: <Widget>[
            ...
            IconButton(
              ...
              icon: FaIcon(FontAwesomeIcons.solidCommentDots, size: 25),
            ...
            IconButton(
              ...
              icon: FaIcon(FontAwesomeIcons.solidPaperPlane, size: 23),
